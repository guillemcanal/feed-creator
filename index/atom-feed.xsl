...
>
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <title>Weeb Feed • <xsl:value-of select="atom:feed/atom:title"/></title>
        <style type="text/css">
      ...
      <body>
        <section>
          <div class="alert">
            <p><strong>This is a web feed</strong>, also known as an Atom feed. <strong>Subscribe</strong> by copying the URL from the address bar into your newsreader app.</p>
          </div>
        </section>
        <section>
  ...
  <xsl:template match="atom:feed">
    ...
    <p>This Atom feed provides the latest posts from <xsl:value-of select="atom:title"/>'s blog.
